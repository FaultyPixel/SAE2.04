...
LOAD DATA LOCAL INFILE './JeuTest/fabricant.csv' INTO TABLE FABRICANT CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/fixation.csv' INTO TABLE FIXATION CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/fournisseur.csv' INTO TABLE FOURNISSEUR CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/noyau.csv' INTO TABLE NOYAU CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/pays_fabrication.csv' INTO TABLE PAYS_FABRICATION CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/poids_skieur.csv' INTO TABLE POIDS_SKIEUR CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/sexe.csv' INTO TABLE SEXE CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/type_ski.csv' INTO TABLE TYPE_SKI CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/niveau_skieur.csv' INTO TABLE NIVEAU_SKIEUR CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/ski.csv' INTO TABLE SKI CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/fourni.csv' INTO TABLE Fourni CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE './JeuTest/etat.csv' INTO TABLE ETAT CHARACTER SET 'utf8' FIELDS TERMINATED BY ',';
...
INSERT INTO ligne (id_ski, id_commande, prix_unit_ligne, quantite_ligne) VALUES
(2, 2, 399.99, 2);
INSERT INTO commentaire (id_commentaire, texte_commentaire, id_user, id_ski) VALUES
(NULL, 'lol', 2, 1);
INSERT INTO panier (date_ajout_panier, quantite_panier, id_user, id_ski) VALUES
('2022-06-06', 1, 2, 1);